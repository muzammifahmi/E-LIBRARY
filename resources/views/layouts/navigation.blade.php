<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/LOGO.png') }} " alt="" class="w-12 h-12">
                    </a>
                </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1 bg-white rounded shadow-lg">
            <span class="block px-4 py-2 text-blue-700 font-bold">Menu</span>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 bg-white rounded shadow-lg mt-2">
            @if(Auth::check())
                <div class="px-4">
            ...
            @else
                <div class="px-4">
                    <a href="{{ route('login') }}"
                        class="block px-4 py-2 bg-white text-blue-600 border border-blue-600 rounded shadow hover:bg-blue-600 hover:text-white transition font-semibold mb-2">
                        Log in
                    </a>
                    <a href="{{ route('register') }}"
                        class="block px-4 py-2 bg-blue-50 text-blue-700 border border-blue-600 rounded shadow hover:bg-blue-600 hover:text-white transition font-semibold">
                        Register
                    </a>
                </div>
            @endif
